...
declare module "favicons" {
    ...
    function favicons(source: string | Buffer | string[], callback?: Callback): void;

    export default favicons;
}

// Very incomplete type definition
declare module "posthtml-parser" {
    ...
    export interface Tree {
        match(options: MatchOptions, callback: (node: any) => void): void;
    }
}
